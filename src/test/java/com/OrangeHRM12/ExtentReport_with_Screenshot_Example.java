...
public class ExtentReport_with_Screenshot_Example {
	...
	public void startReport(){
		...
		extent.addSystemInfo("Host Name", "Welcome to Extent Report")
	...
	public void getResult(ITestResult result) throws Exception{
		if(result.getStatus() == ITestResult.FAILURE){
         ...
         //   String screenshotPath = ExtentReport_with_Screenshot_Example.getScreenhot(driver, result.getName());//Getting error after commenting getscreenshot method
