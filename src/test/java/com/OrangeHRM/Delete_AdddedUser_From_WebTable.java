...
public class Delete_AdddedUser_From_WebTable {
	ChromeDriver driver;
	@BeforeTest
	...
	public void VerifyAddedUser() throws InterruptedException
	{
	    ...
	    //driver.findElementByXPath("//td/a[text()='"+ExpUserName+"']//parent::td/../td/input").click();// different way of writing the above xpath
	   // driver.findElementByXPath("//td/a[text()='"+EnteredValue+"']//parent::td/../td[text()='Admin']").isDisplayed(); //diffrent way of writing the above xpath havig name Aparna but user role is Admin and not ESS
		   // driver.findElementByXPath("//td/a[text()='"+EnteredValue+"']//parent::td/../td[text()='Admin']/../td/input").clik();// .. means entire row of webtable
	    Thread.sleep(2000);
