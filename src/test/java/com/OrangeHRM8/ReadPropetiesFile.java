...
//package created for properties files as com.Resources
...
public class ReadPropetiesFile {
	...
	public static void Flight_Login() throws IOException, InterruptedException {
		...
		File file = new File(System.getProperty("user.dir")+"\\src\\test\\java\\com\\Resources\\ObjectRepositoy.properties");
